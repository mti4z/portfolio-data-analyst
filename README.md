...
## 🎯 Proyecto 5: Segmentación de clientes (Machine Learning)
**[Ver proyecto](./proyecto5_segmentacion_clientes)** · Python (scikit-learn)

Agrupamiento automático de clientes con K-Means sobre métricas RFM (Recencia, Frecuencia, Monto),
identificando 4 segmentos accionables — VIP, Regular y dos niveles de "en riesgo" — con
recomendaciones concretas de negocio para cada uno.
